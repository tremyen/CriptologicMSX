...
NumUnidades  		  equ ramArea+55  ; Variavel => Usada em PrintNumber
ChaTestar				  equ ramArea+56	; Variavel => Guarda o caracter para testar
NumContTeste		  equ ramArea+57	; Variavel => Conta o teste atual
NumContErros		  equ ramArea+58 	; Variavel => Conta os erros
